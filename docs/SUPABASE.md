...
3. Under the project's API settings / Connect dialog, copy the **project URL** and **publishable key**. These two browser-safe values go in a local `.env` file copied from `.env.example`.
